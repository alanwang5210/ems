            ...
            <form action="${url }" method="post" onsubmit="return checkform()">
                <TABLE cellSpacing=0 cellPadding=0 width="60%" align=center border=1>
                    ...
                    <TR height=>
                        ...
                        <TD align="center">
                            <input type="text" name="qingjiariqi" id='qingjiariqiid' size="30" readonly="readonly"
                                   value="${bean.qingjiariqi }" />
                    ...
                    <TR height=>
                        ...
                        <TD align="center">
                            <textarea rows="7" cols="50" name="content" id='contentid'
                                      readonly="readonly">${bean.content }</textarea>
